    ...
    (let ((bg-back   '(:background back))
      ...
      (mapcar (lambda (face) (apply 'create-face-spec face))
              `(;; basic
                ...
                (org-level-1 (,@fmt-none ,@fg-blue))
                (org-level-2 (,@fmt-none ,@fg-cyan))
                (org-level-3 (,@fmt-none ,@fg-yellow))
                (org-level-4 (,@fg-violet))
                (org-level-5 (,@fmt-none ,@fg-base1))
                (org-level-6 (,@fmt-none ,@fg-base01))
                (org-level-7 (,@fmt-none ,@fg-orange))
                (org-level-8 (,@fmt-none ,@fg-violet))
                ;; table
